...
from tools.ideation import BrainstormTool, IdeaGeneratorTool
from tools.requirements import GapAnalyzerTool, UserStoryGeneratorTool
from tools.testing import MutationTesterTool, TestGeneratorTool
...
class TestDay2Tools:
    ...
    async def test_root_cause_analyzer_finds_causes(self):
        ...
        input_data = ToolInput(args={"incident_id": "INC-12345"})
...
class TestTestingTools:
    ...
    async def test_mutation_tester_graceful_degradation(self):
        ...
        input_data = ToolInput(args={"source_path": "core/", "test_path": "tests/"})
    ...
    async def test_test_generator_produces_valid_format(self):
        ...
        input_data = ToolInput(
            args={"target": "calculate_total", "target_type": "unit", "language": "python"}
        )
