...
@router.post(
    "/chain", response_model=ReasoningResponse, dependencies=[Depends(require_authenticated)]
)
...
@router.post(
    "/entity", response_model=ReasoningResponse, dependencies=[Depends(require_authenticated)]
)
...
@rerank_router.post(
    "", response_model=RerankResponse, dependencies=[Depends(require_authenticated)]
)
...
@citations_router.post(
    "", response_model=CitationResponse, dependencies=[Depends(require_authenticated)]
)
